...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    // if $error_message is still null AND  email address is invalid
    ...
    if(!isset($error_message)) {
        ...
        $html_body .= "Suggested Item\n";    
        $html_body .= "Category: " . $category . "\n";
        $html_body .= "Title: " . $title . "\n";
        $html_body .= "Format: " . $format . "\n";
        $html_body .= "Genre: " . $genre . "\n";
        $html_body .= "Year: " . $year . "\n";
        $html_body .= "DETAILS: " . $details . "\n";

        $mail->setFrom($email, $name);
        $mail->addAddress('treehouse@localhost', 'Puyih');     // Add a recipient
        ...
        // if call to send is a success, redirect!
        if($mail->send()) {
    ...
    <form method="post" action="suggest.php">
        ...
        <table>        
            ...
            <tr>
                ...
                <td><input type="text" id="title" name="title" value="<?php if(isset($name)) { echo $title; } ?>"></td>
            </tr> 
            <tr>
                ...
                <td>
                    <select id="format" name="format">
                        ...
                        <optgroup label="Music">
                            <option value="Casette" <?php if( isset($format) && $format == "Casette") { echo " selected"; } ?> >Casette</option>
